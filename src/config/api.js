...
const forceDirectBackend = (process.env.REACT_APP_FORCE_DIRECT_BACKEND || "false").toLowerCase() === "true";
...
const rawUrl = isVercelHost
  ? (forceDirectBackend && envUrl ? envUrl : "/api")
