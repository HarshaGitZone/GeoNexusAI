...
//         // Limit to only 5 items for a professional look
...
//               style={{
//                 flex: 1,
//                 border: isSelectingB ? "2px solid #ef4444" : "",
//                 padding: "8px",
//               }}
//             >
...
//         {/* Comparison Section B - INTEGRATED OLD ACTION BUTTONS */}
//         <section
//           className="control-group comparison-box compact"
//           style={{ display: showLocationB ? "block" : "none" }}
//         >
...
//               className="btn-save" 
//               style={{ flex: 0.7, padding: "8px", fontSize: "12px", opacity: isBFromSavedPlace ? 0.5 : 1 }}
//               title="Save Site B"
//             >
//               ⭐
//             </button>
...
//   //   setSearchQuery("");
//   // };
//   // Add this state near searchQuery
...
//     onSearchResult(parseFloat(item.lat), parseFloat(item.lon), item.display_name);
//   }
//   // Store the full description to show below the search bar
//   setSelectedDescription(item.display_name); 
//   setSuggestions([]);
//   setSearchQuery(""); // Optional: keep empty or set to item.display_name
// };
