...
//   // 2. DYNAMIC RESIDENTIAL (Requires Safety + Cleanliness)
...
//   // 3. DYNAMIC AGRICULTURAL (Requires Soil + Water)
...
//   // 4. DYNAMIC INDUSTRIAL (Requires Logistics + Space)
...
//         )}
//       </div>
//         {/* NEW AUTO-INFERENCE SECTION */}
//       <PotentialSection factors={data.factors} />
...
//       {/* When in Compare Mode, keep PotentialSection inside the column flow */}
//       {isCompareMode && <PotentialSection factors={data.factors} score={data.suitability_score} />}
...
//               </div>
//               <div className="col-2">
//                 {/* Potential Analysis moved to Top-Right in Single View */}
