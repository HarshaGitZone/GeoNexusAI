...
//   //   const isSharedCompare = params.get("compare") === "true";
...
//   //     // Optional: Automatically trigger analysis for shared link
//   //     // handleSubmit(); 
//   //   }
//   // }, []); // Run only on mount
//   // useEffect(() => {
...
//   //   // Set Site B and Force Comparison Mode
//   //   if (isSharedCompare && sharedBLat && sharedBLng) {
//   //     setBLatInput(sharedBLat);
//   //     setBLngInput(sharedBLng);
//   //     setShowLocationB(true); // Opens the input box
//   //     setIsCompareMode(true); // Enables the split results view
      
//   //     // Optional: Automatically trigger the analysis for the shared coordinates
...
//     const sharedBLat = params.get("bLat");
//     const sharedBLng = params.get("bLng");
//     // Change this to check for '1' or 'true' based on your screenshot
...
//     if (isSharedCompare && sharedBLat && sharedBLng) {
//         // 1. Set the raw input values
//         setBLatInput(sharedBLat);
//         setBLngInput(sharedBLng);
        
//         // 2. FORCE the UI to show Location B inputs
//         setShowLocationB(true);
        
//         // 3. FORCE the results container into split-screen mode
//         setIsCompareMode(true);

//         // 4. CRITICAL: Trigger the analysis for Location B automatically
//         // If you don't call this, the UI opens but the results stay black/empty
//         handleCompareSelect(sharedBLat, sharedBLng);
//     }
// }, []);
...
//         setCompareLoading(false); 
//     }
// }, [savedPlaces, deviceLocation, performAnalysis]); // Add dependencies here
...
//         compareResult={compareResult} // ADD THIS LINE
...
export default function LandSuitabilityChecker() {
  ...
  // 1. Perform Analysis (Stable Identity)
  ...
  // 2. Handle Compare Selection (Stable Identity)
  const handleCompareSelect = useCallback(async (tLat, tLng, existingName = null) => {
      setIsSelectingB(false);
      setBLatInput(tLat.toString());
      setBLngInput(tLng.toString());
